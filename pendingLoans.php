...
if($results=mysqli_query($conn, $selectQuery)){
  while($row=mysqli_fetch_row($results)){
    ...
    echo "<form name='ajaxform".$i."' id='ajaxform".$i."' action='ajax-form.php' method='POST'>";
    ...
    echo "<input type='submit' value='Approve' id='approve".$i."' class='btn btn-success btn-sml' />";
    echo "<input type='submit' value='Reject' id='reject".$i."' class='btn btn-danger btn-sml' />";
    echo "</form><br/>\n";
    $i++;
  }
